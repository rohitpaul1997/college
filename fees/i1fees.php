...
<?php 
	if(isset($_POST['submit_stream']))
	{
		...
		{	
			...
			$sql = "UPDATE semester_fees(streamID, sem_1_fees,sem_2_fees,sem_3_fees,sem_4_fees,sem_5_fees,sem_6_fees,";
			$sql=$sql."sem_7_fees,sem_8_fees,no_of_sems,inst_id) SET ('". $amt[0]."',". $amt[1] .",".$amt[2].",".$amt[3]."," ;
			$sql=$sql. $amt[4].",". $amt[5] .",".$amt[6].",".$amt[7].",".$amt[8].",". $count_sem.",1234)"; 
			//echo $amt[0]."-".$amt[1];
