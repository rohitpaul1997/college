...
<html>
  ...
  <body>
    ...
    <form action="iregform.php"  method="POST">
      ...
      <fieldset>
        ...
        <div  class="account-details">
          ...
          <div><label>Repeat password*</label><input type="password" name="email1" required></div>
        </div>
      </fieldset>
      <fieldset>
        <legend>
        ...
        <div  class="personal-details">
          <div>
            ...
            <div><label>Institute_id:</label><input type="text" name="registration_no" required></div>
          </div>
          <div>
      </fieldset>
